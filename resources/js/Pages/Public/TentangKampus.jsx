            ...
            <div className="bg-white py-16">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-24">
                        ...
                        {videoId ? (
                            <div className="relative rounded-2xl overflow-hidden shadow-xl border-4 border-emerald-900 aspect-video bg-slate-900">
                                <iframe 
                            ...
                            <a href={tentang?.video_url} target="_blank" rel="noreferrer" className="block relative rounded-2xl overflow-hidden shadow-xl border-4 border-emerald-900 group cursor-pointer aspect-video bg-slate-900">
                                <img 
