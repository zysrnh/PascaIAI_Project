...
import { FileText, Plus, Trash2, Edit, AlertCircle, FileUp } from 'lucide-react';
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-slate-200">
                        <div className="p-6 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-slate-500">Ubah gambar latar belakang untuk halaman publik Dokumen Institusi.</p>
                            </div>
